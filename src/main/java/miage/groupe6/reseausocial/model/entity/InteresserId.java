...
/**
 * Clé primaire composite pour l'entité Interesser.
 * Composée de l'id de l'utilisateur et de l'événement.
 */
@Embeddable
public class InteresserId implements Serializable{
     ...
     */
    public InteresserId(Long idE, Long idU) {
        this.idE = idE;
        this.idU = idU;
    }
    ...
    /**
     * Vérifie l'égalité entre deux objets InteresserId.
    ...
    public boolean equals(Object obj) {
        ...
        final InteresserId other = (InteresserId) obj;
