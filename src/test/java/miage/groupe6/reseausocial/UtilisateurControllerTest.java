...
public class UtilisateurControllerTest {
    ...
    void afficherFormulaireModification_shouldRenderSettingsInfo() throws Exception {
        ...
        Mockito.when(utilisateurService.getUtilisateurById(1L)).thenReturn(Optional.of(utilisateur));
    ...
    void modifierUtilisateur_shouldRedirectWithSuccess() throws Exception {
        ...
        Mockito.when(utilisateurService.updateUtilisateur(anyLong(), any(Utilisateur.class)))
    ...
    void modifierMotDePasse_shouldSucceed_whenPasswordsMatch() throws Exception {
        Mockito.doNothing().when(utilisateurService).updatePassword(anyLong(), anyString(), anyString());
