...
public class UtilisateurServiceTest {
    ...
    void testUpdateUtilisateur_success() {
        ...
        Utilisateur updated = utilisateurService.updateUtilisateur(1L, newData);
    ...
    void testUpdateUtilisateur_userNotFound() {
        ...
        assertThrows(RuntimeException.class, () -> utilisateurService.updateUtilisateur(1L, utilisateur));
    }
    ...
    void testUpdatePassword_success() {
        ...
        utilisateurService.updatePassword(1L, "oldpass", "newpass123");
    ...
    void testUpdatePassword_wrongCurrentPassword() {
        when(utilisateurRepository.findById(1L)).thenReturn(Optional.of(utilisateur));
        assertThrows(RuntimeException.class, () -> utilisateurService.updatePassword(1L, "wrongpass", "newpass"));
    }

    @Test
    void testUpdatePassword_userNotFound() {
        when(utilisateurRepository.findById(1L)).thenReturn(Optional.empty());
        assertThrows(RuntimeException.class, () -> utilisateurService.updatePassword(1L, "oldpass", "newpass"));
    }
}
